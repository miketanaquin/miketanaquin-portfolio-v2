                        ...
                        <div className="flex flex-col gap-3 text-wrap md:flex-row md:justify-between z-10">
                            ...
                            <div className="flex flex-col gap-3 px-3 md:w-2/3 border-b-2 border-gray-700 py-3">
                                ...
                                <a href="tel:+639061395059" className="flex flex-row gap-1 group cursor-pointer transition-all duration-300" target="_blank"
                                    ...
                                    <h1 className='text-slate-50 tracking-tight leading-relaxed transition-colors duration-300 group-hover:text-orange-400'>+639061395059</h1>
                                </a>
                            </div>
                        </div>
